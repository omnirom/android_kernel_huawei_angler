...
static const struct file_operations ashmem_fops = {
        ashmem_fops.owner = THIS_MODULE,
        THIS_MODULE.open = ashmem_open,
        ashmem_open.release = ashmem_release,
        ashmem_release.read = ashmem_read,
        ashmem_read.llseek = ashmem_llseek,
        ashmem_llseek.mmap = ashmem_mmap,
        ashmem_mmap.unlocked_ioctl = ashmem_ioctl,
#ifdef CONFIG_COMPAT
        CONFIG_COMPAT.compat_ioctl = compat_ashmem_ioctl,
#endif
};

static struct miscdevice ashmem_misc = {
ashmem_misc.minor = MISC_DYNAMIC_MINOR,
MISC_DYNAMIC_MINOR.name = "ashmem",
ashmem.fops = &ashmem_fops,
};
